    ...
    <header className="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-[calc(100vw-2rem)] max-w-[760px]">
      <nav className="bg-white/90 backdrop-blur-md rounded-full shadow-sm border border-neutral-200 px-4 py-2 w-full flex justify-between items-center">
        ...
        <div className="flex items-center gap-2">
          <a
            href="#contact"
            className="hidden md:inline-flex items-center gap-1.5 bg-[#4B4E32] text-white rounded-full px-4 py-2 text-sm font-medium shadow-[0_2px_6px_rgba(45,90,39,0.2)] border border-transparent transition-all duration-300 ease-in-out hover:bg-[#F9F7F4] hover:text-[#4B4E32] hover:border-[#4B4E32] hover:shadow-[0_8px_24px_rgba(45,90,39,0.3)] focus-visible:ring-2 focus-visible:ring-[#4B4E32] focus-visible:ring-offset-2 focus-visible:ring-offset-white focus-visible:outline-none"            >
            Cotizar Evento
          </a>
        ...
        >
          <div className="flex flex-col gap-2">
            ...
            <a
              href="#contact"
              role="menuitem"
              className="flex items-center justify-center gap-1.5 bg-[#4B4E32] text-white rounded-full px-4 py-2.5 text-sm font-medium shadow-[0_2px_4px_rgba(45,90,39,0.1)] transition-all duration-300 ease-in-out hover:bg-[#F9F7F4] hover:text-[#4B4E32] hover:border hover:shadow-[0_2px_4px_rgba(45,90,39,0.1)] hover:scale-[1.01] active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-[#4B4E32] focus-visible:ring-offset-2 focus-visible:ring-offset-white focus-visible:outline-none"
              onClick={closeMenu}
            >
              Cotizar Evento
